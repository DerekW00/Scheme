...
(lambda (d c e) (h o l m))
; expect (lambda (d c e)(h o l m))

(quote (three (four 3) six))
; expect (three (four 3) six)

(cons 10 20 30 410)
; expect (cons 10 20 30 410)

(and (+ 2 1020) (* 102020 10)(* 2 10))
; expect 20

(and (+ 20000 3) #f (* 10203040 3))
; expect #f
...
(let ((this-project-kills-me '(1 2 3)))
  (* (car (cdr (cdr this-project-kills-me))) (car this-project-kills-me)))
; expect 3
